...
import {
  ...
  import {Product_Cart, Product_Cart_Total, Product_Wishlist} from '../actions/UserAction';
                        ...
                        <div className="col-lg-12">
                            <div className="shoping__cart__table">
                                <table>
                                    ...
                                    <tbody>
                                        {
                                            products_list.length>0 && products_wishlist && products_wishlist.length >0 && products_wishlist.map((ar: any, key: number) => {
                    ...
                    <div className="row">
                        <div className="col-lg-12">
                            <div className="shoping__cart__btns">
                                <Link to={`/browse/ref=all`}><button className="primary-btn cart-btn">CONTINUE SHOPPING</button></Link>
