        ...
        <section className="featured spad prod_orig">
            <div className="container">
                <div className="row featured__filter" style={{justifyContent: "center"}}>
                    {
                    deals && deals.length >0 && deals.slice(0, 2).map((ar: any, ctr: number) => {
                        return (

                            <div onClick={(e)=> {setProdIsOpen(true);setUpdateProdSummary(ar?.deal_products[0]?.product);}} key={ar.id} className={`col-lg-6 col-md-12 col-sm-12 mix ${ar.categoryName}`}>
                                <div className="featured__item" style={{backgroundImage: `url('assets/img/product-bg.jpeg')`}}>
                                    ...
                                    <div className="items_wrapper">
                                        ...
                                        <div className="items buy">
                                            ...
                                            <img src={ar?.deal_products[0]?.product?.image_url_main} alt=""/>
                                            <div className="item_title">{ar?.deal_products[0]?.product?.product_name}</div>
