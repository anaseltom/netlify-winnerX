...
import {Product_Cart, Product_Cart_Total, Products_Billing, users} from '../actions/UserAction';
...
const CheckOut: React.FC<any> = ({feature, title, filterControl}) => {
  ...
  const [billingAddress, setBillingAddress] = useState<any>({country:"", region: "", bldg: "", street: "", mobile: "", company: "", orderNotes: ""});
...
const confirmCheckout = () => {
  ...
  const selectRegion = (value: any) => {
    setBillingAddress({...billingAddress, region: value});
  }
                        ...
                        <div className="row">
                            <div className="col-lg-6 col-md-6">
                                ...
                                <div className="row">
                                  <div className="col-lg-6">
                                    <div className="checkout__input">
                                        <p>Building / Apartment<span>*</span></p>
                                        <input type="text" />
                                    </div>
                                  </div>
                                  <div className="col-lg-6">
                            ...
                            <div className="col-lg-6 col-md-6">
                                <div className="checkout__order">
                                    ...
                                    <button  type="submit" className="site-btn">
                                        {
                                            processpay ?
                                            <img className="social_media" src="/assets/img/load.gif" style={{minWidth: "16px"}} alt="" />
                                            :
                                            "PLACE ORDER"
                                        }
