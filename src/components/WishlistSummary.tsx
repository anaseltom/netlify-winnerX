...
import {Product_Cart, Product_Wishlist_Delete, Product_Cart_Total} from '../actions/UserAction';
    ...
    return (
        <tr>
            <td className="shoping__cart__item">
                <img className="image" src={`/assets/img/product/${product?.imageUrlMain}`} alt="" />
            ...
            <td className="shoping__cart__item__close">
                <div className="td_box">
                    <img onClick={ () => {addToCart(product?.productCode)} } className="social_media" src="/assets/img/002-shopping-bag.png" style={{minWidth: "16px"}} alt="" />
                    <img onClick={ () => {deleteProd(product?.productCode)} } className="social_media" src="/assets/img/delete.png" style={{minWidth: "16px"}} alt="" />
                </div>
            </td>
        </tr>
    );
