...
useEffect(() => {
  ...
  google?.accounts.id.initialize({
    client_id: "580884249363-g8fr53jtk9me0u8lsu6sgvkh9mr8as0r.apps.googleusercontent.com",
  ...
  const SigninResponse = (res:any) => {
    console.log("response",res);
      ...
      if(res.status == 200)
      {
        ...
        setSigninMessage({...signinMessage, status: "200", message: "Signin successfully."});
                ...
                <div className="signin-box col-lg-5 col-md-7">
                    <div className="p-3">
                        ...
                        <p className="text-center">Enter your email address and password to access admin panel.</p>
                            <h6 style={{fontSize: "13px",lineHeight: "1"}}>{signinMessage.message}</h6>
                            <div className="row">
                                <div className="col-lg-12">
                                    <div className="form-group">
                                        <label className="text-dark">Username</label>
                                        <input className="form-control email forms_required" id="uname" value = {login.email} onChange={ (e) => { setLogin({ ...login, email: e.target.value }) } } type="text"
                                ...
                                <div className="col-lg-12">
                                    <div className="form-group">
                                        ...
                                        <input className="form-control password forms_required" id="pwd" value = {login.password} onChange={ (e) => { setLogin({ ...login, password: e.target.value }) } } type="password"
                                            placeholder="enter your password" />
                                    </div>
                                </div>
                                <div className="col-lg-12 text-center">
                                    <button onClick={() => {authentication();}} type="submit" className="btn btn-block btn-dark login_button">Sign In</button>
                                </div>
